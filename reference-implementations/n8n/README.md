...
## How to use
1. Import the JSON into your [n8n](../docs/tools/automation_orchestration/n8n.md) instance.
2. Configure credentials for IMAP, Paperless, and Google.
3. Update the LLM model ID to your local [Ollama](../docs/tools/process_understanding/ollama.md) or OpenAI instance.
