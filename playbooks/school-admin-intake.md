...
3.  **Analyze**: [Paperless-AI](../docs/tools/process_understanding/paperless-ai.md) triggers on the document creation to perform a RAG-based analysis.
...
5.  **Sync**:
    ...
    - If consent is required, create a task in [Vikunja](../docs/tools/calendar_tasks/vikunja.md) tagged `Consent`.
