...
| No-Code AI Patterns | [No-Code AI Patterns](../../knowledge_base/learning-map.md) | related | integrated | Learning Map | Referenced in docs/tools/ai_knowledge/google-opal.md |
| DeepSeek | https://www.deepseek.com/en/ | related | integrated | DeepSeek | Referenced in docs/tools/ai_knowledge/openrouter.md |
| Model Routing Guide | [Model Routing Guide](../../knowledge_base/patterns/model_routing_guide.md) | related | integrated | Model Routing Guide | Referenced in docs/tools/ai_knowledge/openrouter.md |
...
| Simulation-Aware Agents | [Simulation-Aware Agents](../../knowledge_base/learning-map.md) | related | integrated | Learning Map | Referenced in docs/tools/ai_knowledge/project-genie.md |
...
| Infinite Canvas Patterns | [Infinite Canvas Patterns](../../knowledge_base/learning-map.md) | related | integrated | Learning Map | Referenced in docs/tools/ai_knowledge/gemini-canvas.md |
...
| Low-Latency Audio Patterns | [Low-Latency Audio Patterns](../../knowledge_base/learning-map.md) | related | integrated | Learning Map | Referenced in docs/tools/ai_knowledge/personaplex.md |
| Gemini | [Gemini](../ai_knowledge/gemini.md) | related | integrated | Gemini | Referenced in docs/tools/ai_knowledge/google-search.md |
| AWS Bedrock | https://aws.amazon.com/bedrock/ | related | integrated | AWS Bedrock | Referenced in docs/tools/ai_knowledge/claude.md |
| Everything Claude Code | [Everything Claude Code](../ai_knowledge/claude-code-setup.md) | related | integrated | Claude Code Setup | Referenced in docs/tools/ai_knowledge/jules.md |
| Make.com | https://www.make.com/ | related | integrated | Make.com | Referenced in docs/tools/ai_knowledge/notion-ai.md |
| AnyType | [AnyType](../intake_storage/anytype.md) | related | integrated | AnyType | Referenced in docs/tools/ai_knowledge/notion-ai.md |
