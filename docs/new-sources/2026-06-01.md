...
| :--- | :--- | :--- | :--- | :--- | :--- |
| bitsandbytes | https://tbd.com | related | integrated | TBD | Referenced in docs/tools/infrastructure/tgi.md |
| Prometheus | https://tbd.com | related | integrated | TBD | Referenced in docs/tools/infrastructure/tgi.md |
| GGUF | https://tbd.com | related | integrated | TBD | Referenced in docs/tools/infrastructure/aphrodite-engine.md |
| DRY Sampler | https://tbd.com | related | integrated | TBD | Referenced in docs/tools/infrastructure/aphrodite-engine.md |
| XTC Sampler | https://tbd.com | related | integrated | TBD | Referenced in docs/tools/infrastructure/aphrodite-engine.md |
| Local LLMs (Ollama, MLX, llama.cpp) | https://tbd.com | related | integrated | docs/tools/ai_knowledge/local_llms.md | Referenced in docs/tools/infrastructure/lm-studio.md |
| JSON Schema | https://tbd.com | related | integrated | TBD | Referenced in docs/tools/infrastructure/sglang.md |
| Python SDK | https://tbd.com | related | integrated | TBD | Referenced in docs/tools/infrastructure/sglang.md |
| LM Studio | https://tbd.com | related | integrated | docs/tools/infrastructure/lm-studio.md | Referenced in docs/tools/infrastructure/localai.md |
| Model Serving Patterns | https://tbd.com | related | integrated | docs/knowledge_base/model_routing_guide.md | Referenced in docs/tools/infrastructure/localai.md |
