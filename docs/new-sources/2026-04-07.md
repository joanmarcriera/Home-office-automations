...
| InterCode | https://github.com/princeton-nlp/intercode?update=2026-04-07 | tool | integrated | TBD | Discovered in terminal-bench.md |
| Simple `time` command with `curl` | https://github.com/ollama/ollama/blob/main/docs/api.md?update=2026-04-07 | tool | integrated | TBD | Discovered in ollama-benchmark-cli.md |
