...
| InterCode | https://github.com/princeton-nlp/intercode?update=2026-04-07 | tool | integrated | [intercode](../tools/benchmarking/intercode.md) | Discovered in terminal-bench.md |
| Simple `time` command with `curl` | https://github.com/ollama/ollama/blob/main/docs/api.md?update=2026-04-07 | tool | integrated | [ollama-benchmark-cli](../tools/benchmarking/ollama-benchmark-cli.md) | Discovered in ollama-benchmark-cli.md |
...
| EvalPlus | https://github.com/evalplus/evalplus?update=2026-04-07 | repository | integrated | [evalplus](../tools/benchmarking/evalplus.md) | Staged from previous logs. |
