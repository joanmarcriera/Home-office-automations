...
1.  **Reasoning Plane (LLM)**: The "Brain" (Claude 5.6, GPT-5.6, Gemini 4.0 Ultra, DeepSeek-V4, Gemma 4, Qwen 3.6 VL). Analyzes state and decides *what* to do. Should never have direct access to SSH keys.
