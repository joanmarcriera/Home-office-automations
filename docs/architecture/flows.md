...
2. **Store**: The scan is saved to a folder monitored by [Syncthing](../tools/intake_storage/syncthing.md) or uploaded directly to [Nextcloud](../services/nextcloud.md).
