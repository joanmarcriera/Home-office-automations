...
| `docs/tools/development_ops/anti_gravity.md` | Resolved | Upgraded to July 2026 standard (v2026.4.x+, Gemini 3.5 series, Gemini Spark, Project Genie, MCP 3.0/3.1), with detailed surfaces, mission configuration patterns, and accurate relative links. |
