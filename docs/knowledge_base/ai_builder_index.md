...
- **Agentic Workflow Design**: Selecting the right framework (e.g., [LangGraph](../tools/frameworks/langgraph.md) or [FastMCP 3.1](../tools/automation_orchestration/mcp.md)) for multi-step tasks.
...
- **FastMCP 3.1 & MCP 3.0 Alignment**: Explicitly highlights tools that support the latest Model Context Protocol standards for agentic interoperability and real-time tool calling.
...
## Limitations
- **Manual Indexing**: Requires proactive updates as the AI ecosystem (e.g., new [Qwen 3.8](../tools/ai_knowledge/qwen.md) and [Gemma 3](local_llms.md) variants) evolves.
...
- [FastMCP 3.1 & MCP 3.0 Task Protocol Specification](https://modelcontextprotocol.io/docs/concepts/tasks)
