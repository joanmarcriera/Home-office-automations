...
- **"I want to build an AI agent"** → [CrewAI](../tools/frameworks/crewai.md)/[AutoGen](../tools/frameworks/autogen.md) + [LangGraph](../tools/frameworks/langgraph.md) + [MCP](agent_protocols.md)
