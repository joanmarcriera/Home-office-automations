...
| OpenRouter | [Docs](https://openrouter.ai/docs) · [Pricing](https://openrouter.ai/pricing) | Yes | Free plan and free-model routing are documented. |
| xAI (Grok API) | [Docs](https://docs.x.ai/) · [Pricing](https://x.ai/api) | Yes | Docs mention monthly free requests/credits. |
| Z.ai (GLM API) | [Docs](https://bigmodel.cn/dev/how-use/introduction) · [Pricing](https://bigmodel.cn/pricing) | Yes | New users can claim free API token packages (BigModel.cn). |
...
| Cerebras Inference | [Docs](https://inference-docs.cerebras.ai/introduction) · [Pricing](https://www.cerebras.ai/pricing) | Yes | Pricing references free-tier usage/credits. |
...
| SambaNova Cloud | [Docs](https://docs.sambanova.ai/) · [Pricing](https://sambanova.ai/pricing) | Unclear | Public page shows paid plans; no stable free policy. |
...
- [OpenRouter API rate limits](https://openrouter.ai/docs/limits)
- [OpenRouter Free Models Router](https://openrouter.ai/docs/quickstart)
- [xAI API](https://x.ai/api)
- [xAI Models/Pricing docs](https://docs.x.ai/)
- [xAI Billing](https://docs.x.ai/)
- [Z.ai Model Pricing (BigModel.cn)](https://bigmodel.cn/pricing)
