...
This prompt is part of the **Maintenance & Governance** layer. It consumes data from the [n8n Log Aggregator](../../scripts/n8n_log_aggregator.py) and generates actionable PRs for the **DevOps** (Jules) layer.
...
2. Feed the contents of `logs_summary.txt` into this prompt.
