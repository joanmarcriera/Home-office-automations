...
| [AutoGen](autogen.md) | Multi-agent conversation framework for complex workflows |
| [CrewAI](crewai.md) | Role-playing, collaborative multi-agent orchestration framework |
...
| [Semantic Kernel](semantic-kernel.md) | SDK for integrating LLMs into conventional apps (.NET, Python) |
