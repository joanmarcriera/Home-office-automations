...
## Typical use cases
- **Multi-Agent Action Capture**: A research agent identifying follow-up reading items and programmatically queuing them in Google Tasks with priority tags and summary notes.
