...
def get_executive_brief(api_token: str) -> FyxerDailyBrief:
    ...
    mock_response = json.dumps({
        ...
        "action_items": [
            ...
            {"task": "Review FastMCP 3.1 contract draft", "source": "meeting", "priority": "normal"}
        ]
    })
