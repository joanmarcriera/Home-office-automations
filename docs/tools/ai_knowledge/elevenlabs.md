...
- **FastMCP 3.1 Streaming**: Native support for Model Context Protocol streaming, enabling sub-100ms audio chunk delivery for real-time agent handoffs.
