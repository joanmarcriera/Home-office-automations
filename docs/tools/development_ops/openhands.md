...
- **Model-agnostic**: Works with Claude 4.8 Opus, GPT-5.5, Gemini, local **Llama 4 Maverick** via Ollama, or any LiteLLM-routed model.
- **MCP 3.0 Native**: Leverages the Task Protocol for structured tool-use and progress tracking.
...
export LLM_MODEL="ollama/llama-4-maverick"
...
- [Llama 4 Maverick](../ai_knowledge/local_llms.md) — Preferred local model for high-autonomy coding tasks.
- [Model Context Protocol](../../tools/automation_orchestration/mcp.md) — Protocol for tool integration and task management.
