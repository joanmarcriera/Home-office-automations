...
- **MCP 3.0 Discovery**: Integrated discovery of [Model Context Protocol (MCP)](../automation_orchestration/mcp.md) tools and routing patterns using the MCP 3.0 Task Protocol.
