...
- **MCP 3.0 Support**: Fully compatible with the [MCP 3.0](../../tools/automation_orchestration/mcp.md) Task Protocol for agent-led evaluation loops.
...
- [MCP 3.0](../../tools/automation_orchestration/mcp.md) — protocol used for automated benchmarking tasks.
