...
## What it is
The AI2 Reasoning Challenge (ARC) is a question-answering dataset consisting of 7,787 multiple-choice science questions, primarily sourced from grade-school standardized assessments. It is divided into an **ARC-Easy** set and a more rigorous **ARC-Challenge** set. As of November 2026, it remains a critical test for "System 2" reasoning in frontier models like **Claude 5.1**, **GPT-5.5**, and **Gemini 4.0**. It is now frequently executed via the [Model Context Protocol (MCP 3.1)](../../tools/automation_orchestration/mcp.md) Task Protocol for automated benchmarking.
...
- **MCP 3.1 Support**: Fully compatible with the [MCP 3.1](../../tools/automation_orchestration/mcp.md) Task Protocol for agent-led evaluation loops.
