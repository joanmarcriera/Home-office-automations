...
- **Cloud Dependent**: Not suitable for 100% offline or air-gapped environments.
...
- For simple logic tasks that don't require external web search (use a local LLM like [Llama 4](../providers/llama.md) instead).
...
response = client.chat.completions.create(
    ...
    messages=[
        ...
        {"role": "user", "content": "What are the current rate limits for the OpenAI API as of June 2026?"}
    ]
)
