...
- [Tavily](../providers/tavily.md) — AI-native search for RAG.
- [Supabase](../infrastructure/supabase.md) — Vector database and backend.
- [Groq](groq.md) — Ultra-low latency LLM inference.
- [Fireworks](fireworks.md) — Fast, serverless inference for open weights.
- [Mistral](mistral.md) — European alternative for open-weights LLMs.
